...
import resultImage from "./hoja.png"; // Asegúrate de que el nombre y la ubicación del archivo sean correctos
import "./App.css";
...
function App() {
  ...
  const calcular = () => {
    ...
    const reduccionEmisiones = (absorcionTotal / 1000000) * 100;
      ...
      <div className="calculation-section">
        <div className="calculator">
          <label>
            ...
            >
              <option value="">Seleccione un gas</option>
